...
% Tab
  tab = {
    ...
    \strpHarmSeven fis'4\2 \strpHarmSeven < b'\1 fis'\2> \strpHarmFive e'\2
    < \tweakTabNoteHead \strpHarmFiveInChord e'\2 \tweak #'X-offset #0.4 c,\6 >
    \strpHarmTwelve e''4\1 \strpHarmTwelve < e''\1 b'\2 >
  }
% Dynamics
%% DynamicsOne
